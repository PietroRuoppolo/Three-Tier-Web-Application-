...
variable "contact" {
  ...
  default = {
    ...
    zip            = "10100"
    phone          = "+39.3330000000"
    email          = "lavoratoreonline12@gmail.com"
  }
}
...
# Attesa finché il dominio risulta "UNAVAILABLE" (cioè registrato e visibile)
